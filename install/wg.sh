...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/${GitUser}/ws/main/add-user/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/${GitUser}/ws/main/delete-user/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/${GitUser}/ws/main/cek-user/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/${GitUser}/ws/main/renew-user/renew-wg.sh"
wget -O wgr "https://raw.githubusercontent.com/${GitUser}/ws/main/menu/wgr.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
